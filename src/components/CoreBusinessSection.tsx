        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {businesses.map((business, index) => (
              <Card 
                key={index} 
                className="bg-white border border-border/50 shadow-sm hover:shadow-md transition-shadow duration-300 rounded-xl"
              >
          ...
          <div className="text-center mt-10">
            <BusinessModal>
              <Button 
                variant="default"
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 text-sm font-semibold rounded-lg"
              >
