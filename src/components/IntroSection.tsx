        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="care-card rounded-2xl p-8 md:p-12 shadow-sm hover-lift">
            <p className="text-lg md:text-xl leading-relaxed text-gray-700 mb-8">
              ...
              비영리 사단법인입니다.
              <br /><br />
              2025년, 우리는 <strong className="text-blue-700">'돌봄을 통해 사회를 하나로 연결하는 것'</strong>을 사명으로 시작합니다. <br />
              난민, 장애인, 노약자, 무주택 취약계층 등 우리 사회의 가장 연약한 이웃들에게<br />
              따뜻한 손길과 실제적인 도움을 전하며, 다음 세대가 사랑과 배려, 나눔의 가치를<br />
              자연스럽게 배울 수 있도록 다양한 프로그램을 준비하고 있습니다.
              <br /><br />
              ...
              <br /><br />
              컴유니티가 바라보는 세상은, 누구도 홀로 남겨지지 않고, 누구도 외면당하지 않는 곳입니다.
              <br />
              연약한 이웃에게 다가가 손을 내밀고, 함께 걸으며, 서로가 서로에게 위로와 희망이 되어주는 사회. 우리가 실천하는 작은 사랑과 나눔이 모여, 더 따뜻하고 아름다운 세상을 만들어가기를 소망합니다.
              <br /><br />
