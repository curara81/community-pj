      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-green-50">
            ...
            <TableHead className="text-center text-green-800 font-semibold border-b">금액</TableHead>
            <TableHead className="text-center text-green-800 font-semibold border-b">세부내용</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          ...
          <TableRow className="bg-green-100">
            <TableCell className="font-bold text-center text-green-800 border-b">총계</TableCell>
            <TableCell className="font-bold text-center text-green-800 border-b font-mono">{totalExpenditure}</TableCell>
