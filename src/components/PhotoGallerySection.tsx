...
const PhotoGallerySection = () => {
  ...
  const galleries = [
    ...
    },
    {
      ...
      caption: t("취약계층 이웃들과 나눈 소중한 시간", "Precious time shared with vulnerable neighbors"),
      image: "/lovable-uploads/bc6c631d-7b67-49aa-8492-4eec1abd239c.png",
      category: "care"
    },
    {
      title: t("교육 및 자립 지원", "Education & Independence Support"),
      caption: t("새로운 희망을 키워가는 교육 현장", "Educational scenes growing new hope"),
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              {t("아직 시작 단계이지만, 그동안 함께했던 의미있는 활동들을 통해 우리가 만들어갈 미래를 상상해보세요.", "Though we're still in the beginning stages, through the meaningful activities we've shared, imagine the future we will create together.")}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {galleries.map((gallery, index) => (
              <Card 
                key={index} 
                className="bg-card border border-border/50 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden"
              >
