        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              <span className="hidden md:block">아직 시작 단계지만, 우리가 함께 만들 수 있는 변화는 무궁무진합니다.
              <br />
              여러분의 작은 참여가 누군가에게는 인생의 터닝포인트가 됩니다.
              <br />
              정기후원 또는 일시후원을 통해 함께해주세요.</span>
              <span className="md:hidden">아직 시작 단계지만, 우리가 함께 만들 수 있는 변화는 무궁무진합니다.
              <br />
              여러분의 작은 참여가 누군가에게는<br />인생의 터닝포인트가 됩니다.
              <br />
              정기후원 또는 일시후원을 통해<br />함께해주세요.</span>
            </p>
          </div>
