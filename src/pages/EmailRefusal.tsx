...
const EmailRefusal = () => {
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "이메일무단수신거부 - 사단법인 컴유니티",
    "description": "사단법인 컴유니티의 이메일무단수신거부 안내입니다.",
  };
  ...
  return (
    <div className="min-h-screen">
      ...
      <SEOHead
        title="이메일무단수신거부 - 사단법인 컴유니티(Comm-Unity)"
        description="사단법인 컴유니티의 이메일무단수신거부 안내입니다. 무단 이메일 수집 금지 및 관련 법률을 안내합니다."
        keywords="이메일무단수신거부, 이메일 수집 금지, 사단법인 컴유니티"
        canonicalUrl="https://www.comm-unity.or.kr/email-refusal"
          ...
          <article className="prose prose-slate max-w-none">
            ...
            <div className="space-y-8 mt-8">
              <section className="mb-10">
                <div className="bg-destructive/10 p-5 rounded-lg border-l-4 border-destructive mb-6">
                  <h2 className="text-xl font-bold text-foreground mb-3">무단 이메일 수집 금지</h2>
                ...
                <div className="bg-accent/50 p-5 rounded-lg border-l-4 border-accent-foreground/30 mb-8">
                  <h2 className="text-xl font-bold text-foreground mb-3">처벌 규정</h2>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <section className="mb-10">
                <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4">개인정보보호법 제22조(개인정보의 수집ㆍ이용 동의 등)</h2>
