...
- usage 평가 기준:
  ...
  - ok: 사용 가능하나 주의 필요 (예: 실링 처리 필수, 정기 관리 필요)
  - avoid: 권장하지 않음 (구조적/내구성/내수성 문제)
  - 일반적 가이드: 대리석은 일반적으로 floor 좋음/wallIndoor 좋음/wetArea 가능(실링)/countertop 가능(산성 주의)/exterior 사진에 따라/floorOutdoor 부적합. 화강석/포셀린은 거의 모든 용도 좋음. 라임스톤은 외부 부적합. 오닉스는 장식용·반투명, 바닥엔 부적합한 경우 많음.
- 응답은 반드시 유효한 JSON 객체.`;
