    ...
    <section className="py-16 md:py-20 bg-background">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-accent-lighter/50 rounded-2xl p-6 md:p-10">
            <div className="text-left text-sm sm:text-base md:text-lg leading-[1.9] text-muted-foreground space-y-4">
              <p>
                ...
                <strong className="text-primary">{t('다문화 가정 사역과 돌봄의 사각지대', 'multicultural family ministry and care blind spots')}</strong>{t('에 놓인 이웃들과 함께하기 위해 설립된 비영리 사단법인입니다.', ' that are placed in, established to be with neighbors, a non-profit corporation.')}
              </p>
              <p>
                {t('2025년, 우리는', '2025, we are')} <strong className="text-accent">{t('"돌봄을 통해 사회를 하나로 연결하는 것"', '"connecting society as one through care"')}</strong>{t('을 사명으로 시작합니다.', ' as our mission.')}{' '}
              ...
              <p className="font-semibold text-primary">
                {t('컴유니티는 사랑이 머무는 곳, 그리고 그 사랑이 세상을 변화시키는 힘이 된다고 믿습니다.', 'Comm.Unity believes that it is a place where love stays, and that love becomes the power to change the world.')}
              </p>
            </div>
