      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-blue-50">
            ...
            <TableHead className="text-center text-blue-800 font-semibold border-b">2024년 결산</TableHead>
        ...
        <TableBody>
          ...
          <TableRow className="bg-blue-100">
            ...
            <TableCell className="font-bold text-center text-blue-800 border-b font-mono">{totalIncome.toLocaleString()}</TableCell>
