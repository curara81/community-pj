    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-foreground mb-8">
          ...
          <div className="care-card rounded-2xl p-8 md:p-12 shadow-sm hover-lift">
            <p className="text-base sm:text-lg md:text-xl leading-relaxed text-muted-foreground mb-8">
              ...
              <br /><br />
              <strong className="text-primary">{t('컴유니티는 사랑이 머무는 곳, 그리고 그 사랑이 세상을 변화시키는 힘이 된다고 믿습니다.', 'Comm.Unity believes that it is a place where love stays, and that love becomes the power to change the world.')}</strong>
            </p>
            ...
            <AboutModal>
              <Button 
                variant="outline"
                size="lg"
                className="border-2 border-accent text-accent hover:bg-accent hover:text-white px-6 py-3 text-lg font-semibold rounded-xl transition-all duration-300"
              >
                {t('더 알아보기', 'Learn More')}
              </Button>
            </AboutModal>
